...
Here, we define the possible parameter ranges, and sample $n$ parameter spaces from within this range using Latin hypercube sampling
...
print("...done sampling. Launching SLURM job...")
```
