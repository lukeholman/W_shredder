...
set.seed(12345)
parameters <- make_latin_hyper_cube_parameter_space(parameter_ranges_4, n_parameter_spaces)
# rbind(make_latin_hyper_cube_parameter_space(parameter_ranges_1, 2 * n_parameter_spaces),
...
#       make_latin_hyper_cube_parameter_space(parameter_ranges_4, n_parameter_spaces))
parameters <- parameters[sample(nrow(parameters)), ] # shuffle to equalise workload across jobs
```
