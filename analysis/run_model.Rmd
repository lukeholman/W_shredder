...
Checking what we have already run is a big job once there are lots of files, so optionally, this part is run using the SLURM job scheduler in order to do it using lots of RAM and CPU cores.
```{r}
...
else source("code/set_up_parameters.R")
