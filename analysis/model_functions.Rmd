...
```{r}
combine_results_files <- function(vector_of_file_names, 
                                  wd = getwd()){
  setwd(wd)
  ...
  for(i in 1:length(vector_of_file_names)){
    list_of_lists <- lapply(vector_of_file_names[[i]], 
                            attempt_to_open)
    ...
    final_pop <- lapply(completed_successfully, # population in the final generation
