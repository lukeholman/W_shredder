...
calc_fecundities <- function(females, 
  ...
  # Deal with this case by setting density = carrying capacity
  ...
  # fecundity <- females$n * (1 + females$fitness * max_fecundity *    # <- OG version
...
run_simulation <- function(row,
  ...
  mating_type_table <- make_mating_type_table(W_shredding_rate  = parameters$W_shredding_rate[row], 
