...
packages <- c("dplyr", "purrr", "tidyr", "stringr", "reshape2", 
              "parallel", "Rcpp", "rslurm", "readr")

shh <- suppressWarnings(lapply(packages, library, character.only = TRUE, quietly = TRUE))
```
...
set_up_mating_type_tables <- function(parameters, 
  ...
  path_to_tables <- "/data/cephfs/punim0243/W_shredder/data/mating_type_tables/"
  ...
  print("print 1")
  # print(data.frame(
  #   x = paste(path_to_tables, uniques, ".rds", sep = ""),
  #   y = file.exists(paste(path_to_tables, uniques, ".rds", sep = ""))
  # ))
  first_one <- paste(path_to_tables, uniques, ".rds", sep = "")[1]
  print(first_one)
  print(file.exists(first_one))
  print(readRDS(first_one))
  print("did it ok")
