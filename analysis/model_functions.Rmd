...
packages <- c("dplyr", "purrr", "tidyr", "stringr", "reshape2", 
              "parallel", "Rcpp", "rslurm", "readr", "tibble", "future", "future.apply")
...
combine_results_files <- function(chunk, all_files, 
  ...
  # Get the filesnames/seeds for each of the 1,000 files in the chunk
  filenames <- gsub("[.]rds", "", gsub("data/sim_results/", "", vector_of_file_names))
  
  # Open all 1,000 files in the chunk, and store as a list. Each element contains a 3-element list
