...
The R scripts used to run the model and generate these figures and tables can be viewed at [https://lukeholman.github.io/W_shredder/](), along with annotations explaining the code.
