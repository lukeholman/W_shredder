...
Finally, we model the possibilty that Z\* drive alleles can create resistant Zr alleles in Z\*Z+ individuals, representing the phenomenon of 'non-homologous end joining' (in which a homing endonuclease deletes its target site instead of being copied over to the homologous chromosome). 
